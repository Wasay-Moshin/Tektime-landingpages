        ...
        <div className="container text-center">
            ...
            <div className="row justify-content-center">
                <div className="col-md-6 mt-4">
                    <img src="Assets/landing/productive-meeting.svg" alt="" className="img-fluid" />
                    <h6 className="main-heading fw-bold fs-6 mt-3 mb-0">Productive meetings</h6>
                    <img src="Assets/landing/border-line.svg" alt="" className="img-fluid" />
                    <p className="description fs-6">Maximize efficiency and collaboration <br className="d-none d-md-block" /> in every meeting.</p>
                </div>
                <div className="col-md-6 mt-4">
                    <img src="Assets/landing/clear-roadmaps.svg" alt="" className="img-fluid" />
                ...
                <div className="col-md-6 mt-4">
                    <img src="Assets/landing/automatic-transcription.svg" alt="" className="img-fluid" />
                ...
                <div className="col-md-6 mt-4">
                    <img src="Assets/landing/detailed-reports.svg" alt="" className="img-fluid" />
